...
export const metadata: Metadata = {
  ...
  description:
    'Explore 108 philosophers across seven eras of Western philosophy. Interactive profiles, era essays, schools of thought, and companion study guides.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Explore 108 philosophers across seven eras of Western philosophy.',
