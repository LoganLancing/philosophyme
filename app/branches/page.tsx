...
export const metadata: Metadata = {
  ...
  description: 'Explore the major branches of philosophy: metaphysics, epistemology, ethics, political philosophy, logic, and aesthetics, along with 21 schools of thought.',
  alternates: { canonical: 'https://philosophyme.co/branches/' },
};
      ...
      <main className="min-h-screen max-w-6xl mx-auto px-4 sm:px-6 pt-24 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
          {branches.map((b) => (
            ...
            >
              <div className="text-2xl mb-2" style={{ color: '#c0a172' }}>{b.icon}</div>
