...
export const metadata: Metadata = {
  ...
  description: 'Explore seven eras of Western philosophy, from the ancient Greeks to contemporary thinkers. Each era raised its own questions and offered its own answers.',
  alternates: { canonical: 'https://philosophyme.co/eras/' },
};
    ...
    <>
      ...
      <main className="min-h-screen max-w-6xl mx-auto px-4 sm:px-6 pt-24 pb-10">
        <div className="text-center mb-12">
          <h1 className="text-3xl sm:text-4xl font-bold mb-6" style={{ color: '#c0a172', fontFamily: "var(--font-playfair), serif" }}>
            Seven Eras of Philosophy
          </h1>
          <p className="text-base max-w-2xl mx-auto" style={{ color: '#8fa3b0' }}>
            2,600 years of philosophy, arranged by the major periods that shaped the tradition.
          </p>
        </div>
        <div className="space-y-6">
          {eras.map((era) => {
            ...
            return (
              <Link
                key={era.id}
                href={`/eras/${era.id.toLowerCase().replace(/\s+/g, '-')}/`}
