...
export const metadata: Metadata = {
  ...
  description: 'Explore seven eras of Western philosophy — from the Ancient Greeks to contemporary thinkers. Each era asked different questions and arrived at different answers.',
};
