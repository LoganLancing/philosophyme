...
export const branches: Branch[] = [
  ...
  { id:"Ethics", name:"Ethics", icon:"⟡", desc:"The study of morality, right and wrong, virtue and vice, justice and injustice.", question:"What should we do? What is good?" },
  { id:"Political Philosophy", name:"Political Philosophy", icon:"△", desc:"The study of government, justice, rights, law, liberty, and the state.", question:"How should we organize society?" },
