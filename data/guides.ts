...
export const guides: GuideProduct[] = [
  {
    ...
    price: '$19.99',
    description:
      'Seven eras of Western philosophy in one volume — from the Ancient Greeks to contemporary thinkers — plus 25 thought experiments included free. A structured reading plan for self-study, book clubs, or alongside a Philosophy 101 course.',
  },
  {
