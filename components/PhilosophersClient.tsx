      ...
      {!hasFilters && (
        <div className="mb-10">
          ...
          >
            ...
            >
              This page is your gateway to {philosophers.length} philosophers spanning 2,600 years of thought. Here&apos;s how to make the most of it:
            </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: '#8fa3b0', fontFamily: 'var(--font-crimson), serif' }}>
                    Type any name, idea, or work to find relevant thinkers instantly.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: '#8fa3b0', fontFamily: 'var(--font-crimson), serif' }}>
                    Narrow by era, branch, or school to find thinkers within a tradition.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: '#8fa3b0', fontFamily: 'var(--font-crimson), serif' }}>
                    Click any card to dive into a philosopher&apos;s ideas, key works, and arguments.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              Below, philosophers are organized by era. Each card&apos;s left border indicates the era it belongs to — scroll down to browse, or use the filters above to find exactly what you&apos;re looking for.
            </p>
          </div>
